...
def Aggre_insurance_Y(df,year):
    ...
    with col1:
        ...
        st.plotly_chart(fig_amount, key=f"agg_ins_y_amount_{year}")
    with col2:
        ...
        st.plotly_chart(fig_count, key=f"agg_ins_y_count_{year}")
    ...
    with col1:
        ...
        st.plotly_chart(fig_india_1, key=f"agg_ins_y_india1_{year}")
    ...
    with col2:
        ...
        st.plotly_chart(fig_india_2, key=f"agg_ins_y_india2_{year}")
...
if select == "Home":
    ...
    with col2:
        st.image(Image.open(r"C:\Users\nirma\OneDrive\Desktop\labmentix projects\PhonePe\logo.png"))

    col3,col4= st.columns(2)
    
    with col3:
        st.image(Image.open(r"C:\Users\nirma\OneDrive\Desktop\labmentix projects\PhonePe\img2.png"))
    ...
    with col6:
        st.image(Image.open(r"C:\Users\nirma\OneDrive\Desktop\labmentix projects\PhonePe\img3.jpg"))
